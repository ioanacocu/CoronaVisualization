                ...
                for row in csv_reader:
                    if line_count == 6:
                        ...
                        if line_count > 6:
                            ...
                            measures_index=[m[1] for m in measures if not( m[0]==cName or m[0]==cFirstCaseDate or m[0]==cContinent)]
                            measures4Country = []
                            name = ''
                            firstCaseDate = ''
                            continent = ''
                            ...
                            if len(name)>1:
                                country=Country(name, firstCaseDate, continent, measures4Country, geoId)
                                countries.insert(len(countries), country)
                        line_count += 1
                print(f'Processed {line_count} lines.')
                return countries, [m[0] for m in measures if not(m[0]==cName or m[0]==cFirstCaseDate or m[0]==cContinent or m[0]==cCountryCode)]
