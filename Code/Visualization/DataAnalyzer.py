                ...
                if line_count == 0:
                    ...
                    if line_count > 0:
                        ...
                        for element in row:
                            ...
                            element_no += 1
                        if country not in timeSeries.keys():
                            timeSeries[country]={}
                        if year not in timeSeries[country].keys():
                            timeSeries[country][year]={}
                        if month not in timeSeries[country][year].keys():
                            timeSeries[country][year][month]={}
                        timeSeries[country][year][month][day]=(cases, deaths)
